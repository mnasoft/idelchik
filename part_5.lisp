...
(defun idl-5-5-dzeta(Re d1 d0 l mikro)
...
"
  (+
    ...
    (idl-5-6-dzeta-tr Re d1 d0 l mikro)))


(defun idl-5-6-dzeta-tr(Re d1 d0 l mikro)
  "Диффузор с доотрывным течением
...
(Idl-5-23-1-dzeta 0.079 0.049 0.060 (* 0.001 0.02)) "
  (let* ((alfa_r (* 2.0 (atan (/ (- D1 D0) 2.0 l))))
    ...
    (break "alfa_r ~S" (* alfa_r (/ 180. pi)))
    (+ dzeta (idl-5-6-dzeta-tr 2e5 D1 D0 (al 0.071 0.020 60.0) 0.02e-3))))
